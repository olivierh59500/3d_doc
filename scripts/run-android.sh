...
go run github.com/hajimehoshi/ebiten/v2/cmd/ebitenmobile@v2.9.11 \
    ...
    -androidapi 23 \
    -javapkg com.olivierh.threeddoc \
    -o android/app/libs/threeddoc.aar \
    "$mobile_package"
...
echo "→ Lancement de TCB 3D DOC"
$adb_path shell am force-stop com.olivierh.threeddoc
$adb_path shell am start -n com.olivierh.threeddoc/.MainActivity
